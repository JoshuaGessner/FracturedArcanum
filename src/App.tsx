...
function AppShell() {
  ...
  // Owner/admin operations console. Declared here, after
  // `ensureRecentPasskeyAuth`, because privileged actions re-prompt for a
  // passkey through it. The hook owns its own state; AppShell only forwards
  // the cross-cutting values it cannot know about.
  ...
  // Friends, challenges, trading, clans. Reads its own slice through
  // useSocialState(); only the cross-cutting values are passed in.
