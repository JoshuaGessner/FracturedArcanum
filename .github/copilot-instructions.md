...
- When modifying economy constants (rune rewards, pack costs, breakdown values), consult `docs/ECONOMY_BALANCE.md` and recalculate the affected progression timelines.
